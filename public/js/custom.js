...
// > Nav submenu show hide on mobile by = custom.js
	 ...
	 function mobile_nav(){
		...
		jQuery("<span class=' glyphicon glyphicon-plus '></span>").insertAfter(".has-child > a");
		
	
		 jQuery('.has-child a+span').on('click', function(ev) {
		   $(this).next(jQuery('.sub-menu')).slideToggle('fast', function(){
